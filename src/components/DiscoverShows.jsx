...
export default function DiscoverShows() {
  // Dashboard rows for TV discovery
  ...
  // TMDB auth header reused across requests
  ...
  // Normalize TV payload for shared card component
  ...
  useEffect(() => {
    const fetchDashboards = async () => {
      try {
        // Load all dashboard sections in parallel for quicker render
        const [
          trendingRes,
          acclaimedRes,
          actionRes,
          ...
          fetch(
            "https://api.themoviedb.org/3/discover/tv?language=en-US&sort_by=vote_average.desc&vote_count.gte=1000",
            fetchOptions,
          ),
          fetch(
            "https://api.themoviedb.org/3/discover/tv?language=en-US&with_genres=10759&without_genres=16",
            fetchOptions,
          ),
          fetch(
            "https://api.themoviedb.org/3/discover/tv?language=en-US&with_genres=10765&without_genres=16",
            fetchOptions,
          ),
          fetch(
            "https://api.themoviedb.org/3/discover/tv?language=en-US&with_genres=18&without_genres=16",
            fetchOptions,
          ),
          fetch(
            "https://api.themoviedb.org/3/discover/tv?language=en-US&with_genres=16&with_original_language=ja&sort_by=popularity.desc",
            fetchOptions,
          ),
          fetch(
            "https://api.themoviedb.org/3/discover/tv?language=en-US&with_genres=16&sort_by=vote_average.desc&vote_count.gte=500",
            fetchOptions,
          ),
          fetch(
            "https://api.themoviedb.org/3/discover/tv?language=en-US&with_original_language=ko&sort_by=popularity.desc",
            fetchOptions,
          ),
          fetch(
